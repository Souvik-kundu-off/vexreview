...
<p align="center">
  <img src="Vex.svg" alt="VexReview Logo" width="200"/>
</p>

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Part of GitPlus](https://img.shields.io/badge/GitPlus-Ecosystem-6366f1?style=flat&logo=databricks)](https://github.com/arpan7sarkar/GitPlus.git)

---

## Overview

**VexReview** is an AI-powered code reviewer and summarizer for GitHub pull requests — built as a core component of the [GitPlus](https://github.com/arpan7sarkar/GitPlus.git) ecosystem, powered by **Actian Vector DB** for deep semantic codebase understanding.
...
## 🏗️ Part of the GitPlus Ecosystem

VexReview is designed to work alongside **GitPlus** — a full-stack developer toolset for understanding, navigating, and maintaining large codebases using AI + **Actan Vector DB**.

| Tool | Role |
|---|---|
| **GitPlus Dashboard** | Visual codebase explorer, AI chat, security scans |
| **VexReview** | Automated AI PR reviews integrated into GitHub Workflows |
| **GitPlus CLI** | Terminal-based indexing, scanning, and analysis |
